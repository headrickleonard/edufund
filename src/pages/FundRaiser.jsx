...
const Fundheader = () => {
    return (
        <div className="w-full h-screen flex md:flex-row md:items-center md:justify-center">
            <div
                className="p-8 bg-gradient-to-b from-teal-600 to-current flex flex-col items-center justify-end md:relative md:flex md:flex-col md:items-center md:justify-center backdrop-blur-md md:bg-gradient-to-br md:from-cyan-400 md:to-teal-800 md:w-3/4 h-full">
                ...
                <div
                    className="invisible lg:visible w-72 h-72 -z-10 bg-gradient-to-br from-cyan to-current rounded-full absolute md:right-24"></div>
            </div>
